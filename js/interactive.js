...
console.log('HHHHH', theseBalls[0].side);

myRange().value = theseBalls[0].side;

const changeSize = (size, pelotas) => pelotas[0].side = size;


myRange().addEventListener('input', (range) => changeSize(range.target.value, theseBalls));